...
var _Tiwae = __webpack_require__(115);

var _Tiwae2 = _interopRequireDefault(_Tiwae);

var _TiwaeDefault = __webpack_require__(116);

var _TiwaeDefault2 = _interopRequireDefault(_TiwaeDefault);

var _stylesheetComposer = __webpack_require__(52);
...
var Tiwae = (_temp = _class = function (_React$Component) {
  ...
  function Tiwae(props) {
    ...
    var columns = props.columns.map(function (option) {
    ...
    var isAllChecked = columns.every(function (column) {
  ...
  (0, _createClass3.default)(Tiwae, [{
    ...
    value: function render() {
      ...
      var selectAll = this.props.isSelectAll ? _react2.default.createElement(
        'div',
        { className: styles.selectAll, onClick: this.onSelectAll },
      ...
      var controls = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: styles.reset, onClick: this.onReset },
          'Reset to Default'
        )
      );

      var items = columns.map(function (option, index) {
        var lock = index < _this2.props.lockLimit && (index === 0 || columns[index - 1].locked) ? _react2.default.createElement('div', {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', { className: styles.dropdownTriangle }),
          _react2.default.createElement(
            'div',
            {
  ...
  defaultColumns: _propTypes2.default.arrayOf(_propTypes2.default.shape()).isRequired,
  isSelectAll: _propTypes2.default.bool,
  lockLimit: _propTypes2.default.number,
  onChange: _propTypes2.default.func.isRequired,
  onSelectAll: _propTypes2.default.func.isRequired,
  ...
  this.onDragOverElement = function (evt) {
    ...
    var lastLocked = _this3.state.columns.reduce(function (acc, option, i) {
  ...
  this.onDrop = function (evt) {
    ...
    var lastLocked = columns.reduce(function (acc, option, i) {
      return option.locked ? i : acc;
    }, -1);

    if (ghostIndex > lastLocked) {
      var originalElement = columns.splice(startIndex, 1);
      columns.splice(ghostIndex, 0, originalElement[0]);
    }

    _this3.setState({ ghostIndex: -1, startIndex: -1, columns: columns });
    _this3.props.onChange(columns);
  };
  ...
  this.onCheck = function (evt) {
    ...
    var isAllChecked = _this3.state.columns.every(function (column) {
      return !column.hidden;
    });

    _this3.setState({ columns: columns, ghostIndex: -1, startIndex: -1, isAllChecked: isAllChecked });
    _this3.props.onChange(columns);
  };

  this.onSelectAll = function () {
    var isAllChecked = !_this3.state.isAllChecked;

    _this3.setState({ isAllChecked: isAllChecked });
    _this3.props.onSelectAll(isAllChecked);
  };
  ...
  this.onLock = function (evt) {
    ...
    var columns = _this3.state.columns.map(function (option, i) {
      if (i === index) {
  ...
  this.onReset = function () {
    var columns = _this3.props.defaultColumns.map(function (option) {
      return (0, _assign2.default)(option, {
        hidden: false,
        locked: false
      });
    ...
    _this3.setState({ ghostIndex: -1, columns: columns, startIndex: -1, isAllChecked: isAllChecked });
    _this3.props.onChange(columns);
  };
...
exports.locals = {
	...
	"dropdownTriangle": "dropdownTriangle__src-Tiwae__1y7Z3",
	...
	"selectAll": "selectAll__src-Tiwae__13hN6",
...
var _Tiwae = __webpack_require__(51);
