...
var _Ripanga = __webpack_require__(13);
...
var Caret = function Caret(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: (0, _classnames2.default)(_Ripanga2.default.caret, (_cx = {}, (0, _defineProperty3.default)(_cx, _Ripanga2.default.closed, closed), (0, _defineProperty3.default)(_cx, _Ripanga2.default.disabled, disabled), _cx)),
      onClick: onClick
    },
...
var _RipangaDefault = __webpack_require__(132);

var _RipangaDefault2 = _interopRequireDefault(_RipangaDefault);

var _stylesheetComposer = __webpack_require__(59);
...
var Ripanga = (_temp = _class = function (_React$Component) {
  ...
  function Ripanga(props) {
    ...
    styles = (0, _stylesheetComposer2.default)(_Ripanga2.default, props.stylesheets);
  ...
  (0, _createClass3.default)(Ripanga, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: styles.container, ref: function ref(el) {
            _this2.ripangaContainer = el;
          } },
        _react2.default.createElement(
          'div',
          { className: styles.headContainer, ref: function ref(el) {
              _this2.headContainer = el;
            } },
          _react2.default.createElement(
            'table',
            { className: styles.head, ref: function ref(el) {
                _this2.headTable = el;
              } },
        ...
        _react2.default.createElement(
          'div',
          { className: styles.bodyContainer, ref: function ref(el) {
              _this2.bodyContainer = el;
            } },
          _react2.default.createElement(
            'table',
            { className: styles.body, ref: function ref(el) {
                _this2.bodyTable = el;
              } },
        ...
        _react2.default.createElement(
          'div',
          { className: styles.stickyContainer, ref: function ref(el) {
              _this2.stickyContainer = el;
            } },
          (0, _RipangaStickyCells2.default)({
            collapsedIds: collapsedIds,
            idKey: idKey,
        ...
        _react2.default.createElement(
          'div',
          { className: styles.stickyCellHead, ref: function ref(el) {
              _this2.stickyHead = el;
            } },
          _react2.default.createElement(_reactRange2.default, {
  ...
  globalKey: _react.PropTypes.string.isRequired,
  ...
  stylesheets: [_RipangaDefault2.default]
  ...
  this.setHeadPosition = function (value) {
    _this3.stickyHead.style.position = value;
    _this3.headContainer.style.position = value;
  };

  this.trackSlider = function () {
    // dispatch(trackEvent('project_area.submittals.table_actions.horizontal_scroll'));
  };

  this.applyStaticBounds = function (side) {
    _this3.setHeadPosition('absolute');
    _this3.placePanelStatic(side);
  };

  this.applyStickyBounds = function (side) {
    _this3.setHeadPosition('fixed');
    _this3.placePanelSticky(side);
  };

  this.hideSticky = function () {
    _this3.stickyHead.style.display = 'none';
    _this3.stickyContainer.style.display = 'none';
  };

  this.placePanelStatic = function (side) {
    var headContainer = _this3.headContainer,
        stickyContainer = _this3.stickyContainer,
        stickyHead = _this3.stickyHead,
        ripangaContainer = _this3.ripangaContainer;
    ...
    switch (side) {
      ...
      case 'none':
        _this3.hideSticky();
        _this3.headContainer.style.left = 0;
        break;
      default:
  ...
  this.placePanelSticky = function (side) {
    var headContainer = _this3.headContainer,
        stickyContainer = _this3.stickyContainer,
        stickyHead = _this3.stickyHead,
        ripangaContainer = _this3.ripangaContainer;
  ...
  this.recalculateSticky = function () {
    if (_this3.stickyHeaderActive()) {
      _this3.applyStickyBounds(_this3.props.panelPosition);
    } else {
      _this3.applyStaticBounds(_this3.props.panelPosition);
    }
  };

  this.storeCheckedStates = function () {
    sessionStorage.setItem(_this3.props.globalKey + '/CHECKED', (0, _stringify2.default)(_this3.state.checkedIds));
  };
  ...
  this.resizeHead = function () {
    var bodyContainer = _this3.bodyContainer,
        bodyTable = _this3.bodyTable,
        headContainer = _this3.headContainer,
    ...
    _this3.recalculateSticky();
  };

  this.resizeRipanga = function () {
    var headContainer = _this3.headContainer,
        stickyContainer = _this3.stickyContainer,
        ripangaContainer = _this3.ripangaContainer;
    var panelPosition = _this3.props.panelPosition;
  ...
  this.scrollSlider = function (e) {
    ...
    _this3.setState({ sliderValue: parseInt(v, 0) });

    bodyContainer.scrollLeft = scrollWidth * v / delta;
  };

  this.scrollBody = function () {
    var bodyContainer = _this3.bodyContainer,
        headContainer = _this3.headContainer,
        slider = _this3.slider,
        stickyContainer = _this3.stickyContainer;
    ...
    var scrollWidth = bodyContainer.scrollWidth - bodyContainer.offsetWidth;
    var sliderValue = bodyContainer.scrollLeft * delta / scrollWidth;

    _this3.setState({ sliderValue: sliderValue });
  };

  this.scrollWindow = function () {
    if (_this3.ripangaContainer === undefined) {
      return;
    }
  ...
  this.stickyHeaderActive = function () {
    var ripangaBounds = _this3.ripangaContainer.getBoundingClientRect();
...
RipangaBodyRow.propTypes = {
  ...
  renderBodyRow: _react.PropTypes.func.isRequired,
...
var _RipangaGroupRow = __webpack_require__(62);

var _RipangaGroupRow2 = _interopRequireDefault(_RipangaGroupRow);

var _RipangaBodyRow = __webpack_require__(60);
...
var RipangaBodyRows = function RipangaBodyRows(_ref) {
  ...
  var renderGroupRow = function renderGroupRow(group) {
    var initialColspan = showCheckboxes ? 1 : 0;
  ...
  var rows = isGrouped ? renderBodyGroups() : renderBodyRows(tableData[0]);
...
RipangaBodyRows.propTypes = {
  ...
  idKey: _react.PropTypes.string,
  isGrouped: _react.PropTypes.bool,
...
var RipangaGroupRow = function RipangaGroupRow(_ref) {
  ...
  var checkbox = showCheckboxes ? _react2.default.createElement('input', { type: 'checkbox', checked: isChecked, onChange: onChange }) : null;

  var caret = (0, _RipangaCaret2.default)({ disabled: isDisabled, closed: isCollapsed, onClick: onCaretClick });

  return _react2.default.createElement(
    'tr',
    { className: _Ripanga2.default.groupRow, key: 'group-' + groupData.key.name },
    _react2.default.createElement(
      'td',
      { colSpan: colSpan },
      _react2.default.createElement(
...
var _qs = __webpack_require__(128);
...
var _RipangaHeadCell = __webpack_require__(63);
...
var RipangaHeadRow = function RipangaHeadRow(_ref) {
  ...
  var cells = columnDefinitions.reduce(function (acc, def) {
    if (def.hidden !== true) {
      acc.push((0, _RipangaHeadCell2.default)({ def: def, globalKey: globalKey, idKey: idKey, onSort: onSort }));
    }

    return acc;
  }, []);

  var checkbox = showCheckboxes ? _react2.default.createElement('input', { type: 'checkbox', checked: allChecked, onChange: onCheckAll }) : null;

  var caret = isGrouped ? (0, _RipangaCaret2.default)({ closed: allCollapsed, onClick: onCollapseAll }) : null;

  if (checkbox || caret) {
    cells.unshift(_react2.default.createElement(
      'th',
      { key: 'head-controls', className: styles.headControls },
      caret,
      checkbox
    ));
  }
...
RipangaHeadRow.propTypes = {
  ...
  isGrouped: _react.PropTypes.bool.isRequired,
...
var RipangaStickyCells = function RipangaStickyCells(_ref) {
  var collapsedIds = _ref.collapsedIds,
      idKey = _ref.idKey,
      renderBodyStickyCell = _ref.renderBodyStickyCell,
      _ref$renderGroupStick = _ref.renderGroupStickyCell,
      renderGroupStickyCell = _ref$renderGroupStick === undefined ? function () {
    return null;
  } : _ref$renderGroupStick,
      tableData = _ref.tableData;

  var renderBodyStickyCells = function renderBodyStickyCells(group) {
    if (group.key && collapsedIds[group.key.name] === true) {
      return [];
    }
    ...
    return group.data.map(function (obj) {
      return _react2.default.createElement(
        'div',
        {
...
RipangaStickyCells.propTypes = {
  collapsedIds: _react.PropTypes.arrayOf(_react.PropTypes.any).isRequired,
  idKey: _react.PropTypes.string,
  renderBodyStickyCell: _react.PropTypes.func.isRequired,
  renderGroupStickyCell: _react.PropTypes.func,
  tableData: _react.PropTypes.arrayOf(_react.PropTypes.object).isRequired
};
...
// module
exports.push([module.i, ".container__src-Ripanga__Ofnqz {\n  position: relative; }\n\n.headContainer__src-Ripanga__2bKh7 {\n  background: salmon;\n  border: solid gray;\n  border-width: 1px 0 1px 1px;\n  cursor: default;\n  left: 0;\n  overflow: hidden;\n  top: 0;\n  z-index: 2; }\n\n.bodyContainer__src-Ripanga__3iIHo {\n  background: aqua;\n  border: solid gray;\n  border-width: 0 0 0 1px;\n  overflow: auto;\n  z-index: 1; }\n\n.head__src-Ripanga__13GZv {\n  background: palette(gray, light);\n  font-size: 11px;\n  table-layout: fixed; }\n  .head__src-Ripanga__13GZv th {\n    border-right: 1px solid palette(gray, base);\n    font-weight: bold;\n    line-height: 20px;\n    overflow: hidden;\n    padding: 10px;\n    text-overflow: ellipsis;\n    white-space: nowrap; }\n  .head__src-Ripanga__13GZv .columnSort__src-Ripanga__3rlFx {\n    white-space: normal; }\n  .head__src-Ripanga__13GZv .sortable__src-Ripanga__34Ii6 {\n    cursor: pointer; }\n  .head__src-Ripanga__13GZv .label__src-Ripanga__qQjAr {\n    display: inline-block;\n    margin-right: 5px; }\n\n.body__src-Ripanga__3ZTlv {\n  position: relative; }\n  .body__src-Ripanga__3ZTlv td {\n    border-right: 1px solid palette(gray, base);\n    border-bottom: 1px solid palette(gray, base);\n    font-size: 11px;\n    padding: 10px;\n    position: relative; }\n\n.groupRow__src-Ripanga__3rO1h {\n  background: palette(gray, xlight); }\n  .groupRow__src-Ripanga__3rO1h .controls__src-Ripanga__oypzM {\n    display: inline-block;\n    padding: 0 10px; }\n  .groupRow__src-Ripanga__3rO1h .title__src-Ripanga__2iOMx {\n    display: inline-block; }\n  .groupRow__src-Ripanga__3rO1h td {\n    padding: 0;\n    vertical-align: middle; }\n\n.caret__src-Ripanga__2UmVp {\n  color: palette(gray, xdark);\n  cursor: pointer;\n  display: inline-block;\n  font-size: 11px;\n  height: 20px;\n  line-height: 20px;\n  text-align: center;\n  transition: transform 0.2s ease;\n  width: 20px; }\n  .caret__src-Ripanga__2UmVp.closed__src-Ripanga__3xJMU, .caret__src-Ripanga__2UmVp.disabled__src-Ripanga__2aL6A {\n    transform: rotate(-180deg); }\n  .caret__src-Ripanga__2UmVp.disabled__src-Ripanga__2aL6A {\n    color: palette(gray, base);\n    cursor: not-allowed; }\n\n.stickyCell__src-Ripanga__1_K6i {\n  background: forestgreen;\n  border: solid gray;\n  border-width: 0 1px 1px;\n  text-align: center; }\n\n.stickyCellGroup__src-Ripanga__N27NA {\n  background: violet;\n  padding: 0;\n  text-align: right; }\n\n.stickyCellHead__src-Ripanga__1ekVw {\n  background: bisque;\n  border-top: 1px solid gray;\n  padding: 0;\n  position: absolute;\n  right: 0;\n  top: 0;\n  text-align: center;\n  z-index: 3; }\n  .stickyCellHead__src-Ripanga__1ekVw .horizontalScroller__src-Ripanga__IFpDt {\n    height: 14px;\n    left: 50%;\n    margin-left: -40px;\n    margin-top: -7px;\n    padding: 0;\n    position: absolute;\n    top: 50%;\n    width: 80px; }\n\n.stickyContainer__src-Ripanga__yCqKx {\n  background: #fff;\n  border-top: 1px solid palette(gray, base);\n  position: absolute;\n  overflow: hidden;\n  right: 0;\n  top: 0;\n  width: 110px; }\n", ""]);

// exports
exports.locals = {
	"container": "container__src-Ripanga__Ofnqz",
	"headContainer": "headContainer__src-Ripanga__2bKh7",
	"bodyContainer": "bodyContainer__src-Ripanga__3iIHo",
	"head": "head__src-Ripanga__13GZv",
	"columnSort": "columnSort__src-Ripanga__3rlFx",
	"sortable": "sortable__src-Ripanga__34Ii6",
	"label": "label__src-Ripanga__qQjAr",
	"body": "body__src-Ripanga__3ZTlv",
	"groupRow": "groupRow__src-Ripanga__3rO1h",
	"controls": "controls__src-Ripanga__oypzM",
	"title": "title__src-Ripanga__2iOMx",
	"caret": "caret__src-Ripanga__2UmVp",
	"closed": "closed__src-Ripanga__3xJMU",
	"disabled": "disabled__src-Ripanga__2aL6A",
	"stickyCell": "stickyCell__src-Ripanga__1_K6i",
	"stickyCellGroup": "stickyCellGroup__src-Ripanga__N27NA stickyCell__src-Ripanga__1_K6i",
	"stickyCellHead": "stickyCellHead__src-Ripanga__1ekVw stickyCell__src-Ripanga__1_K6i",
	"horizontalScroller": "horizontalScroller__src-Ripanga__IFpDt",
	"stickyContainer": "stickyContainer__src-Ripanga__yCqKx"
};
...
var _Ripanga = __webpack_require__(58);
